...
for(let i=0; i<space.length; i++){
    space[i]=new Array(height+4); //4를 더한 이유는 시작부터 겹치는 것 방지.
...
class tetris{ //테트리스 만들기!
    ...
    makeBlock(){
        ...
        let selectedOne=this.blocks[Math.floor(Math.random()*NOB)];
        ...
        this.blocks[this.NOB++]=nextBlockPosition[index];
